...
<div class="screenlet" style="margin: 1em;">
  <div class="screenlet-title-bar container-fluid pl-0">
    <ul class="pl-0">
      <li class="h1">${uiLabelMap.CommonVisualThemes}</li>
      <li class="btn btn-secondary"><a href="<@ofbizUrl>main</@ofbizUrl>">${uiLabelMap.CommonDone}</a></li>
    </ul>
    <br class="clear"/>
  </div>
  ...
  <#if visualThemes?has_content>
    ...
    <table cellspacing="0" class="basic-table table table-striped">
