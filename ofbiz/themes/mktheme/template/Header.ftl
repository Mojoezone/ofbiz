...
<body>
  ...
  <div class="page-container container-fluid">
    ...
    <div id="masthead" class="conatianer-fluid">
      <ul class="row">
        ...
        <#else>
          ...
          <#if headerImageUrl??>
                <#if organizationLogoLinkURL?has_content>
                    <li class="col-1"><a href="<@ofbizUrl>${logoLinkURL}</@ofbizUrl>"><img class="img-thumbnail" alt="${layoutSettings.companyName}" src="<@ofbizContentUrl>${StringUtil.wrapString(organizationLogoLinkURL)}</@ofbizContentUrl>"></a></li>
                    <#else>
                    <li class="logo-area col-1"><a href="<@ofbizUrl>${logoLinkURL}</@ofbizUrl>"><img alt="${layoutSettings.companyName}" src="<@ofbizContentUrl>${StringUtil.wrapString(headerImageUrl)}</@ofbizContentUrl>"/></a></li>
                </#if>
          </#if>
          <#if layoutSettings.middleTopMessage1?has_content && layoutSettings.middleTopMessage1 != " ">
            <li class="col-2 small">
        ...
        <li class="control-area col-9 float-right">
